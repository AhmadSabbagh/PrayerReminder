...
public class MyPager extends PagerAdapter {
    ...
    */
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .placeholder(R.drawable.quranpage)
                .error(R.drawable.quranpage);
        Glide.with(context).load("http://islamicbook.ws/6/"+(604-position)+".png").apply(options).into(imageView);
    ...
    */
    ...
    private int getImageAt(int position) {
        switch (position) {
            case 0:
                return R.drawable.animationstart;
            case 1:
                return R.drawable.back;
            case 2:
                return R.drawable.background_wall_paper;
            case 3:
